...
?>
        ...
        <form method='post' action='gestionSalarié_vérification.php'>
         ...
         <div class='Fonction'>
                ...
                <input type="radio" name="contrat" value="CDD" <?php if($contrat=="CDD") echo 'checked'; ?> />
                <label>CDD </label>
                <input type="radio" name="contrat" value="CDI" <?php if($contrat=="CDI") echo 'checked'; ?>/>
                <label>CDI </label></br></br>
                </br></br>
                <label id=contrat ><strong>Durée du contrat en mois(0 si CDI)</strong> </label>
                <input type='text' name='contratDuree_mois' id='idcontrat' placeholder='Durée du contrat' value=<?php echo $contratDuree_mois; ?> >
                </br><label for='idLine'>___________________________________________________________</label>
